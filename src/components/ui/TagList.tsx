        ...
        return (
          <li key={item} className="group relative">
            <span
              ...
              className="flex min-h-8 min-w-8 items-center justify-center gap-2 border border-steel p-1.5 text-silver transition-colors duration-150 group-hover:border-interactive group-hover:text-bone"
            >
              <TechLogo icons={tech.icons} className="size-5" />
            </span>
            <span
              aria-hidden
              className="pointer-events-none absolute bottom-full left-1/2 z-20 mb-2 -translate-x-1/2 border border-steel bg-ink px-2 py-1 text-xs font-medium whitespace-nowrap text-bone opacity-0 transition-opacity duration-150 group-hover:opacity-100"
            >
              {tech.label}
            </span>
          </li>
