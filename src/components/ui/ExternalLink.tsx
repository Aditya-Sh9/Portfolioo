...
const BASE =
  "inline-flex items-center gap-2 border-2 px-4 py-2 text-xs font-bold tracking-widest uppercase transition-transform duration-150 active:translate-x-[3px] active:translate-y-[3px] active:shadow-none pointer-coarse:min-h-11";

/** Shared brutalist link styles; also used for internal links that should match. */
export const LINK_STYLES = {
  primary: `${BASE} border-bone text-bone shadow-brutal-sm hover:-translate-x-px hover:-translate-y-px hover:bg-bone hover:text-ink`,
