            ...
            <article className="grid border-2 border-steel bg-charcoal transition-colors duration-150 hover:border-bone lg:grid-cols-12">
              <div className="@container relative isolate flex flex-col overflow-hidden border-b-2 border-steel bg-ink p-6 md:p-8 lg:col-span-5 lg:border-r-2 lg:border-b-0">
                ...
                <p className="text-xs font-bold tracking-widest text-silver uppercase">
                  <span className="text-accent">{entry.period}</span>
                </p>
                ...
                <ol className="mt-8 grid gap-5">
                  {entry.highlights.map((highlight, i) => (
                    <li key={highlight} className="flex gap-4">
                      <span
                        aria-hidden
                        className="mt-1 text-xs font-bold tracking-widest text-accent"
                      >
                        {String(i + 1).padStart(2, "0")}
                      </span>
                      <p className="max-w-xl leading-relaxed text-silver">{highlight}</p>
                    </li>
                  ))}
                </ol>
